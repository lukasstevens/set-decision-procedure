...
We also formalise a refinement to an executable specification from which Isabelle can generate code.
...
To deal with this problem, we formalise a light-weight type system as displayed in \autoref{fig:types}. 
