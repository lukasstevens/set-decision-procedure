...
\todo[inline]{First give intuition then technical details}
...
\todo[inline]{Reformulate with initial formula}
...
\todo[inline]{In particular initial formula is satisfied}
...
\end{lstlisting}
  ...
  Therefore, the transitive closure of the membership relation \lstinline!{(x, y). x $\in$ elts y}$^\text{+}$! contains a cycle. 
