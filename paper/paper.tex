...
\begin{table*}
  ...
  \begin{tabular}{p{0.21\textwidth}cp{0.18\textwidth} p{0.01\textwidth} p{0.21\textwidth}cp{0.18\textwidth}}
    ...
    \lstinline!$\ton$ $\eqS$ $\ttw$, ($\fmNegSymbol$) a! & $\Longrightarrow$ & \lstinline!($\fmNegSymbol$) a[$\ttw$/$\ton$]! \\

    \lstinline!s $\inS$ Single t! & $\Longrightarrow$ & \lstinline!s $\eqS$ t! &&
    \lstinline!$\ton$ $\eqS$ $\ttw$, ($\fmNegSymbol$) a! & $\Longrightarrow$ & \lstinline!($\fmNegSymbol$) a[$\ton$/$\ttw$]! \\
...
\begin{table*}
  ...
  \begin{tabular}{>{\centering\arraybackslash}p{0.28\textwidth} >{\centering\arraybackslash}p{0.3\textwidth} >{\centering\arraybackslash}p{0.3\textwidth}}
    ...
    \end{tabular}
         & Test & \lstinline!p $\in$ set b $\lor$ @\fmNeg{p}@ $\in$ set b! \\
    ...
    \end{tabular}
         & Test & \lstinline!@\fmNeg{p}@ $\in$ set b $\lor$ p $\in$ set b! \\
