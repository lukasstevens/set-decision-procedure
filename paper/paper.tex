...
We call this kind of branches \textit{well-formed} branches and define a predicate for it.
...
In \autoref{sec:correct}, we also show that both properties easily transfer to the decision procedure which, together with termination, give us total correctness.
...
\end{lstlisting}
\todo[inline]{Non-Overlapping!}
Again, we need to ensure that the function terminates for it to be well-defined.
